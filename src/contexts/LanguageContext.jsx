...
const translations = {
  ...
  kg: {
    ...
    heroSubtitle: 'Okurmen IT Academy — программалоо дүйнөсүнө ишенимдүү жолкударыңыз. IT саласында негиздерден баштап көнүккөн даражага чейин үйрөтөбүзз.',
    chooseDirection: 'Багыт тандаңыз',
    contactUs: 'Байланыш алуу',
    programmingIllustration: 'Программисттердин иш иллюстрациясы',
    students: 'Студенттер',
    courses: 'Курсдор',
    employmentRate: 'Ишке ойдоштуруу',
    
    // About
    aboutTitle: 'Биз жөнүндө',
    aboutDescription: 'Okurmen IT Academy — программалоо боюнча нөлдөн сапаттуу билим берүүн камсыздагын заманбап кылган IT-академия. Студенттерибизди информацион технология саласында иштеп чыгаарылуудагы мамандар кылууга жардам беребиз.',
    ...
    practicalApproachDesc: 'Көптөгөн практикалык тапшырмалар жана чынайы долбоорлор.',
    employment: 'Ишке ойдоштуруу',
    ...
    kidsFutureSkillsDesc: 'Логикалык ой жүгүртүү, креативдүүлүк жана цифра грамоталыкты өнүктүрүү',
    ...
    fullFeatures: ['Толук программа', 'Чоң тереңдикте үйрөнүү', 'Долбоор иши', 'Ишке ойдоштуруу'],
    ...
    certFeatures: ['Официалдуу ырастоо', 'Иш бериүчүлөр тарабынан таануу', 'Ишке ойдоштурууга жардам'],
